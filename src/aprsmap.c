...
static char moving(aprsdecode_pOPHIST op)
{
   ...
   { /* with */
      ...
      return !aprsdecode_lums.moving || (((uint32_t)
                anonym->lastinftyp>0UL && (uint32_t)
                anonym->lastinftyp<100UL) && (int32_t)anonym->lastkmh>0L)
...
static uint32_t findfreecol(aprsdecode_pOPHIST opn)
{
   ...
   if (c<48UL) {
      ...
      if (aprspos_posvalid(pos)) {
         ...
         while (op) {
            if (((int32_t)op->trackcol>=48L && (int32_t)op->trackcol<58L)
                 && aprspos_distance(op->lastpos, pos)<50.0f) {
               cs |= (1UL<<(int32_t)op->trackcol-48L);
            }
            op = op->next;
         }
      }
...
{
   if (op && (int32_t)op->trackcol>=48L) {
      op->trackcol = (signed char)((((int32_t)op->trackcol-48L)+1L)%11L+48L);
   }
} /* end changecolor() */
...
static char isvis(const uint8_t vismask)
{
   ...
   { /* with */
      ...
      return (((anonym->drawhints&vismask)!=0U && anonym->sym.tab!='\001')
                ...
                && (aprsdecode_lums.wxcol==0 || (uint32_t)
                anonym->lastinftyp>=100UL && anonym->temptime+3600UL>aprsdecode_systime)
                ;
   }
} /* end isvis() */
...
{
   return (uint32_t)inf>=10UL && (uint32_t)inf<100UL;
} /* end isdrivespeed() */
                ...
                uint32_t tilltime)
{
   ...
   while (aprsdecode_click.ops) {
      if ((((isvis(0x18U) && (int32_t)aprsdecode_click.ops->trackcol<58L)
                ...
                struct aprsdecode_CLICKOBJECT * hoverobj)
{
   ...
   while (aprsdecode_click.ops) {
      if ((isvis(0x8U) && ((0x2U & aprsdecode_click.ops->drawhints)!=0)
         ...
         if ((int32_t)aprsdecode_click.ops->lastkmh>0L) {
            if (isdrivespeed(aprsdecode_click.ops->lastinftyp)) {
               if (useri_configon(useri_fARROW)
                ...
                (float)((uint32_t)aprsdecode_click.ops->lastinftyp-10UL)
                *(-6.9813170079773E-2f), 0UL, lig, col);
               }
            }
            else if ((uint32_t)
                aprsdecode_click.ops->lastinftyp>=110UL && (uint32_t)
                aprsdecode_click.ops->lastinftyp<200UL) {
               if (useri_configon(useri_fWINDSYM)
                ...
                (float)((uint32_t)
                aprsdecode_click.ops->lastinftyp-110UL)
                *(-6.9813170079773E-2f),
                ...
                char objmove, char withvalues)
{
   ...
   while (aprsdecode_click.ops) {
      ...
      if ((isvis(0x8U) && (objmove && object==yesno || !objmove && moving(aprsdecode_click.ops)
         ...
         if (withvalues) {
            if ((uint32_t)aprsdecode_click.ops->lastinftyp>=100UL) {
               /* temperature */
               if (((useri_configon(useri_fTEMP) && (int32_t)
                aprsdecode_click.ops->lasttempalt>=-99L) && (int32_t)
                aprsdecode_click.ops->lasttempalt<=99L)
                && aprsdecode_click.ops->temptime+3600UL>aprsdecode_systime) {
                ...
                aprsdecode_click.ops->lasttempalt, 1UL, s, 256ul);
                  ...
                  if ((int32_t)aprsdecode_click.ops->lasttempalt<0L) {
                     col.r = 20UL;
                     col.g = 180UL;
                     col.b = 255UL;
                  }
                  else if ((int32_t)aprsdecode_click.ops->lasttempalt<40L) {
               ...
               if (useri_configon(useri_fKMH)) {
                  ...
                  if (((uint32_t)
                aprsdecode_click.ops->lastinftyp>0UL && (int32_t)
                aprsdecode_click.ops->lastkmh>0L)
                && aprsdecode_click.ops->lasttime+aprsdecode_lums.kmhtime>aprsdecode_systime)
                 {
                     aprsstr_IntToStr((int32_t)
...
static char getgate(aprsdecode_pVARDAT v, aprsdecode_pOPHIST * gate)
{
   ...
   { /* with */
      ...
      if ((uint32_t)anonym->igatelen==0UL) return 0;
            ...
            if ((trk || aprsdecode_click.pf->next==0)
               ...
               { /* with */
                  ...
                  if (anonym->lastref==aprsdecode_click.pf && (nofilt || !(aprsdecode_click.pf->nodraw&~0x9U)
                     ...
                     if ((uint32_t)
                anonym->igatelen>0UL && maptool_mapxy(anonym->pos, &x0,
                &y00)>=0L) {
   ...
   while (aprsdecode_click.ops) {
      if ((((((aprspos_posvalid(aprsdecode_click.ops->lastpos) && (uint8_t)
                ...
                &y)>=-1L) && aprsdecode_click.ops->temptime+3600UL>aprsdecode_systime)
                 && (((uint32_t)
                aprsdecode_click.ops->lastinftyp>=100UL || what=='1')
                || what=='R')) {
         ...
         if (((x0>-radius && x0<maptool_xsize+radius) && y00>-radius)
            ...
            if (t>0L) {
                ...
                *rfimg->Len0+my];
                                 ...
                                 if (what=='T' && (uint32_t)anonym->r==0UL)
                 anonym->r = (uint16_t)t;
                                 else {
...
static void find(char allpoi)
{
   ...
   if (!qth(h, 201ul)) {
      /* not an aprs frame and not a locator */
      if (aprsdecode_Decode(h, 201ul,
                &dat)>=0L && aprspos_posvalid(dat.pos)) {
         aprsdecode_drawbeacon(h, 201ul, 1); /* aprs frame with position */
      }
      pos = dat.pos;
      if (!aprspos_posvalid(pos)) {
...
{
   if ((int32_t)c<=1023L) {
      return (int32_t)(uint32_t)(uint8_t)gammatab[c];
   }
   else return 255L;
   return 0;
} /* end flo() */
   ...
   if (aprsdecode_WITHX11 && aprsdecode_click.dryrun) {
      ...
      if (xosi_Shift) aprsdecode_click.cmd = 'X';
         ...
         if (aprsdecode_click.table[0UL]
            ...
            if ((uint32_t)aprsdecode_click.table[0UL].opf->lastinftyp>=100UL)
                 {
               /* wx symbol */
...
{
   X2C_BEGIN(&argc,argv,1,20000000l,1000000000l);
   libsrtm_BEGIN();
   aprstext_BEGIN();
   aprsstr_BEGIN();
   aprspos_BEGIN();
